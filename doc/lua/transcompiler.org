...
stat ::=  ';' |
	 ...
	 'each' namelist 'in' explist '{' block '}' |
	 functiondef

classdef ::= 'class' ['pub'] Name [ ':' Name ] '{' classfieldlist '}'

classfieldlist ::= { memberdef } { methoddef } { advertisedef }
...
exp ::=  literal | '...' | functiondef |
	 ...
	 prefixexp | tableconstructor | listconstructor | arrayconstructor | exp binop exp | unop exp
...
arrayconstructor ::= '[@' [fieldlist | literal ':' Numeral ] ']'
